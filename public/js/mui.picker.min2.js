...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">		<div class="mui-dtpicker-header">			<button data-id="btn-cancel" class="mui-btn">取消</button>			<button data-id="btn-ok" class="mui-btn mui-btn-blue">确定</button>		</div>		<div id="mui-qrCodeInfo" data-id="mui-qrCodeInfo">条码号：</div>	<div class="mui-minepicker-title">请选择儿童出生日期：</div>	<div class="mui-dtpicker-body">			<div data-id="picker-y" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-m" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-d" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-h" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-i" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>		</div>	</div>';
	...
	//plugin
	var DtPicker2 = $.DtPicker2 = $.Class.extend({
		init: function(options) {
			var self = this;
			...
			var ui = self.ui = {
                ...
                qrCode:  $('[data-id="mui-qrCodeInfo"]', _picker)[0],
			};
        ...
        _setQrCode: function() {
            ...
            t = e.options,
            i = e.ui;
            i.qrCode.innerText = t.qrCode;
        },
        _setQrCode2: function(e) {
        	var t = this,
            i = t.ui;
            i.qrCode.innerText = e;
        },
		...
		_create: function(options) {
            ...
            options.qrCode = options.qrCode || "条码号：",
			self.options = options;
			var now = new Date();
