...
export default {
  ...
  methods: {
    ...
    setDetfaultParams (nextParam) {
      ...
      this.fadulthbsag.code = fadulthbsagcode || '03'
      this.fadulthbsab.code = fadulthbsabcode || '03'
      ...
      this.fadulthbsag.text = fadulthbsag || '未检测'
      this.fadulthbsab.text = fadulthbsab || '未检测'
